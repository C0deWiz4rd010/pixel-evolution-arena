...
const BASE_MONSTERS: Monster[] = [
  ...
  { id: 'M004', name: 'Shadepuff', stage: 'Baby', type: 'Dark', icon: '🌑', level: 2, xp: 10, maxXp: 90, attack: 20, defense: 14, speed: 24, hp: 66, rarity: 'Common', unlocked: true, evolutionTargets: ['M010'] },
  { id: 'M005', name: 'Sparkit', stage: 'Baby', type: 'Light', icon: '✨', level: 1, xp: 0, maxXp: 100, attack: 19, defense: 14, speed: 28, hp: 62, rarity: 'Common', unlocked: false, evolutionTargets: ['M011'] },
  { id: 'M006', name: 'Pebblip', stage: 'Baby', type: 'Beast', icon: '🟤', level: 1, xp: 0, maxXp: 100, attack: 17, defense: 24, speed: 12, hp: 88, rarity: 'Common', unlocked: false, evolutionTargets: ['M022'] },
  { id: 'M007', name: 'Aquabun', stage: 'In-Training', type: 'Water', icon: '🐰', level: 3, xp: 42, maxXp: 130, attack: 30, defense: 24, speed: 34, hp: 104, rarity: 'Common', unlocked: true, evolutionTargets: ['M014'], requirements: { level: 2, coins: 100, dnaShards: 5 } },
  ...
  { id: 'M031', name: 'Fangquartz', stage: 'Champion', type: 'Beast', icon: '💎', level: 1, xp: 0, maxXp: 280, attack: 98, defense: 66, speed: 62, hp: 230, rarity: 'Rare', unlocked: false, evolutionTargets: ['M048'], requirements: { level: 7, coins: 330, dnaShards: 18 } },
  { id: 'M032', name: 'Stormjaw', stage: 'Ultimate', type: 'Water', icon: '🌊', level: 1, xp: 0, maxXp: 390, attack: 134, defense: 92, speed: 104, hp: 360, rarity: 'Epic', unlocked: false, evolutionTargets: ['M039'], requirements: { level: 11, coins: 550, dnaShards: 28 } },
  ...
  { id: 'M034', name: 'Infernodon', stage: 'Ultimate', type: 'Fire', icon: '🌋', level: 1, xp: 0, maxXp: 410, attack: 162, defense: 82, speed: 118, hp: 340, rarity: 'Epic', unlocked: false, evolutionTargets: ['M042'], requirements: { level: 11, coins: 550, dnaShards: 28 } },
  ...
  { id: 'M038', name: 'Mechabison', stage: 'Ultimate', type: 'Machine', icon: '🐂', level: 1, xp: 0, maxXp: 430, attack: 124, defense: 160, speed: 58, hp: 410, rarity: 'Epic', unlocked: false, evolutionTargets: ['M046'], requirements: { level: 11, coins: 600, dnaShards: 30, item: 'Armor Core' } },
  ...
  { id: 'M044', name: 'Virulisk', stage: 'Mega', type: 'Toxic', icon: '☣️', level: 1, xp: 0, maxXp: 620, attack: 188, defense: 170, speed: 136, hp: 500, rarity: 'Legendary', unlocked: false, evolutionTargets: [], requirements: { level: 15, coins: 800, dnaShards: 40 } },
